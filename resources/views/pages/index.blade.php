...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <!-- <a href="index.html" class="logo"><img src="home_assets/img/logo.png" alt="" class="img-fluid"></a>-->
      ...
      <div class="container" data-aos="fade-up">
            ...
            <div class="row justify-content-end">
              ...
              <div class="col-lg-3 col-md-5 col-6 d-md-flex align-items-md-stretch">
                <div class="count-box">
                  ...
                  <span data-purecounter-start="0" data-purecounter-end="235" data-purecounter-duration="1" class="purecounter"></span>
                  <p>Customer</p>
                </div>
              </div>
        ...
        <div class="row p-4 justify-content-center">
          ...
          <div class="col-lg-5 pt-3 pt-lg-0 content">
            <h1>Who We Are</h1>
            <p class="fst-italic">
              Welcome to our barbershop website! We are a team of experienced and talented barbers dedicated to providing top-notch grooming services to our valued clients. With a passion for our craft and an eye for detail, we take pride in delivering exceptional haircuts, stylish grooming, and an unforgettable barbershop experience. Our barbers are highly skilled in a variety of cutting-edge techniques and styles, from classic barbering to the latest trends.
            </p>
          </div>
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row p-4 my-1">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 p-3">
                ...
                <p>
                  Kami menawarkan Hair Cut Premium untuk perubahan yang menarik, Full Trim untuk tatanan rambut yang rapi, dan Hair Vitamin untuk perawatan rambut yang sehat.
                </p>
              </div>
          ...
          <div class="tab-pane m-3" id="tab-2">
            <div class="row p-4 my-1">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 p-3">
                ...
                <p>
                  Segera temukan pengalaman perawatan rambut terbaik dengan layanan kami yang memikat, Protein Hairmask dan Creambath. Dapatkan rambut yang sehat, kuat, dan indah, serta rasa santai yang menyegarkan.
                </p>
                <p class="fst-italic">
                  Berikut ini adalah beberapa layanan yang tersedia
                </p>
          ...
          <div class="tab-pane m-3" id="tab-3">
            <div class="row p-4 my-1">
              <div class="col-lg-6 order-2 order-lg-1 mt-3 mt-lg-0 p-3">
                <h2>Make Over</h2>
                <p>
                  Dengan layanan kami, Smoothing Pro akan melunakkan rambut Anda menjadi kelembutan yang menakjubkan, Top Perming akan memberikan tekstur dan gaya yang tak tertandingi, sedangkan Coloring Full Black, Coloring Hairlight, dan Coloring Peek A Boo akan memberikan warna yang menggoda imajinasi.
                </p>
                <p class="fst-italic">
                  Berikut ini adalah beberapa layanan yang tersedia
                </p>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            <div class="portfolio-info">
              ...
              <p>Rp300.000</p>
              <a href="home_assets/img/portfolio/portfolio-1.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="App 1"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            ...
            <div class="portfolio-info">
              ...
              <p>Rp220.000</p>
              <a href="home_assets/img/portfolio/portfolio-2.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            <div class="portfolio-info">
              <h4>Detox Shampoo</h4>
              <p>Rp500.000</p>
              <a href="home_assets/img/portfolio/portfolio-3.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="App 2"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            ...
            <div class="portfolio-info">
              <h4>Beard Balm</h4>
              <p>Rp300.000</p>
              <a href="home_assets/img/portfolio/portfolio-4.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 2"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            ...
            <div class="portfolio-info">
              <h4>Pomade</h4>
              <p>Rp250.000</p>
              <a href="home_assets/img/portfolio/portfolio-5.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 2"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            <div class="portfolio-info">
              ...
              <p>Rp350.000</p>
              <a href="home_assets/img/portfolio/portfolio-6.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="App 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            ...
            <div class="portfolio-info">
              ...
              <p>Rp270.000</p>
              <a href="home_assets/img/portfolio/portfolio-7.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 1"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            ...
            <div class="portfolio-info">
              ...
              <p>Rp280.000</p>
              <a href="home_assets/img/portfolio/portfolio-8.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Card 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            ...
            <div class="portfolio-info">
              ...
              <p>Rp280.000</p>
              <a href="home_assets/img/portfolio/portfolio-9.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Web 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="pic"><img src="home_assets/img/person-1.jpg" class="img-fluid" alt=""></div>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="member">
              <div class="pic"><img src="home_assets/img/person-2.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
                <h4>Lincoln Torff</h4>
                <span>Barber</span>
                <div class="social">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
            <div class="member">
              <div class="pic"><img src="home_assets/img/person-3.jpg" class="img-fluid" alt=""></div>
              <div class="member-info">
